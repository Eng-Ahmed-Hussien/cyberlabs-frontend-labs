        ...
        <div className='p-8 flex flex-col items-center text-center'>
          ...
          <motion.div
            ...
            <p className='text-muted-foreground font-medium mb-8 max-w-xs mx-auto'>
              You successfully compromised{' '}
              <span className='text-foreground font-bold'>
                {template?.title || 'Target System'}
              </span>
              .
            </p>
          </motion.div>
            ...
            <motion.div
              ...
              <div className='flex flex-wrap justify-center gap-2'>
                {template.skills.map((skill, idx) => (
                  <div
                    key={idx}
                    className='flex items-center gap-1.5 bg-background border border-border px-3 py-1.5 rounded-full shadow-sm text-xs font-semibold'>
